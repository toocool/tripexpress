        ...
        <div class="col-sm-10 col-md-11 main">
          <div class="row" >
            <div class="col-sm-12 col-md-12" style="padding-left:0px;">
                <h1 class="page-header"><a href="<?php echo base_url().'admin/members' ?>"><i class="icon-arrow-left-3"></i></a> Add Member</h1>
            </div>
          </div>  
          <div class="row">
             ...
             <?php echo form_open('admin/members/add_member'); ?>
                ...
                <div class="form-group">
                  ...
                  <label class="radio-inline">
                    <input type="radio" name="role" value="0" <?php echo set_radio('role', '0'); ?>> Administrator
                  </label>
                  <label class="radio-inline">
                    <input type="radio" name="role" value="1" <?php echo set_radio('role', '1'); ?>> Empoyee
                  </label>
                  <label class="radio-inline">
                    <input type="radio" name="role" value="2" <?php echo set_radio('role', '2'); ?>> Reseller
                  </label>
