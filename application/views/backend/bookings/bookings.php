              ...
              <table class="table table-bordered">
                ...
                <tbody>
                  ...
                  ?>
                      ...
                      <td>
                        <a href="<?php echo base_url('admin/bookings/pdf/'.$booking->booking_id); ?>" target="_blank"><button type="button" class="btn btn-primary btn-xs"><span class="icon-pencil"></span> Invoice</button></a>
